...
void mat_setup_zero()
{
    mat_zero_square = Mat<zz_pX>();
    mat_zero_square.SetDims(64,64);

    mat_zero_64x63 = Mat<zz_pX>();
    mat_zero_square.SetDims(64,63);

    mat_zero_64x48 = Mat<zz_pX>();
    mat_zero_square.SetDims(64,48);
